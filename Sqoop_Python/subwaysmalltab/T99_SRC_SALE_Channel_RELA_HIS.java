// ORM class for table 'T99_SRC_SALE_Channel_RELA_HIS'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Jul 02 17:16:50 CST 2020
...
public class T99_SRC_SALE_Channel_RELA_HIS extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("Sale_Channel_Cd", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        T99_SRC_SALE_Channel_RELA_HIS.this.Sale_Channel_Cd = (String)value;
      }
    });
    setters.put("SRC_Sale_Channel_cd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T99_SRC_SALE_Channel_RELA_HIS.this.SRC_Sale_Channel_cd = (String)value;
      }
    });
    setters.put("Source_Sys_Cd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T99_SRC_SALE_Channel_RELA_HIS.this.Source_Sys_Cd = (String)value;
      }
    });
    setters.put("Effect_Dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T99_SRC_SALE_Channel_RELA_HIS.this.Effect_Dt = (java.sql.Date)value;
      }
    });
    setters.put("Invalid_Dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T99_SRC_SALE_Channel_RELA_HIS.this.Invalid_Dt = (java.sql.Date)value;
      }
    });
  }
  public T99_SRC_SALE_Channel_RELA_HIS() {
    init0();
  }
  ...
  public T99_SRC_SALE_Channel_RELA_HIS with_Sale_Channel_Cd(String Sale_Channel_Cd) {
    this.Sale_Channel_Cd = Sale_Channel_Cd;
    return this;
  }
  private String SRC_Sale_Channel_cd;
  public String get_SRC_Sale_Channel_cd() {
    return SRC_Sale_Channel_cd;
  }
  public void set_SRC_Sale_Channel_cd(String SRC_Sale_Channel_cd) {
    this.SRC_Sale_Channel_cd = SRC_Sale_Channel_cd;
  }
  public T99_SRC_SALE_Channel_RELA_HIS with_SRC_Sale_Channel_cd(String SRC_Sale_Channel_cd) {
    this.SRC_Sale_Channel_cd = SRC_Sale_Channel_cd;
    return this;
  }
  ...
  public T99_SRC_SALE_Channel_RELA_HIS with_Source_Sys_Cd(String Source_Sys_Cd) {
    this.Source_Sys_Cd = Source_Sys_Cd;
    return this;
  }
  ...
  public T99_SRC_SALE_Channel_RELA_HIS with_Effect_Dt(java.sql.Date Effect_Dt) {
    this.Effect_Dt = Effect_Dt;
    return this;
  }
  ...
  public T99_SRC_SALE_Channel_RELA_HIS with_Invalid_Dt(java.sql.Date Invalid_Dt) {
    this.Invalid_Dt = Invalid_Dt;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof T99_SRC_SALE_Channel_RELA_HIS)) {
      return false;
    }
    T99_SRC_SALE_Channel_RELA_HIS that = (T99_SRC_SALE_Channel_RELA_HIS) o;
    boolean equal = true;
    equal = equal && (this.Sale_Channel_Cd == null ? that.Sale_Channel_Cd == null : this.Sale_Channel_Cd.equals(that.Sale_Channel_Cd));
    equal = equal && (this.SRC_Sale_Channel_cd == null ? that.SRC_Sale_Channel_cd == null : this.SRC_Sale_Channel_cd.equals(that.SRC_Sale_Channel_cd));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.SRC_Sale_Channel_cd = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(SRC_Sale_Channel_cd, 2 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.SRC_Sale_Channel_cd = null;
    } else {
    this.SRC_Sale_Channel_cd = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.SRC_Sale_Channel_cd) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, SRC_Sale_Channel_cd);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(SRC_Sale_Channel_cd==null?"\\N":SRC_Sale_Channel_cd, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.SRC_Sale_Channel_cd = null; } else {
      this.SRC_Sale_Channel_cd = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    T99_SRC_SALE_Channel_RELA_HIS o = (T99_SRC_SALE_Channel_RELA_HIS) super.clone();
  ...
  public void clone0(T99_SRC_SALE_Channel_RELA_HIS o) throws CloneNotSupportedException {
    o.Effect_Dt = (o.Effect_Dt != null) ? (java.sql.Date) o.Effect_Dt.clone() : null;
    o.Invalid_Dt = (o.Invalid_Dt != null) ? (java.sql.Date) o.Invalid_Dt.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("SRC_Sale_Channel_cd", this.SRC_Sale_Channel_cd);
