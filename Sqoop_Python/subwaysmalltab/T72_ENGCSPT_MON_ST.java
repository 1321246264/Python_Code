// ORM class for table 'T72_ENGCSPT_MON_ST'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon Jun 29 16:59:29 CST 2020
...
public class T72_ENGCSPT_MON_ST extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("Stat_Mon", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.Stat_Mon = (String)value;
      }
    });
    setters.put("HouseHld_pty_ID", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.HouseHld_pty_ID = (String)value;
      }
    });
    setters.put("EngCspt_Cd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.EngCspt_Cd = (String)value;
      }
    });
    setters.put("HouseHld_pty_Nm", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.HouseHld_pty_Nm = (String)value;
      }
    });
    setters.put("HouseHld_Lvl", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.HouseHld_Lvl = (Integer)value;
      }
    });
    setters.put("EngCspt_Nm", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.EngCspt_Nm = (String)value;
      }
    });
    setters.put("Measr_Unit", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.Measr_Unit = (String)value;
      }
    });
    setters.put("Sum_Val", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.Sum_Val = (java.math.BigDecimal)value;
      }
    });
    setters.put("Data_Dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.Data_Dt = (java.sql.Date)value;
      }
    });
    setters.put("REC_SEQ", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T72_ENGCSPT_MON_ST.this.REC_SEQ = (Integer)value;
      }
    });
  }
  public T72_ENGCSPT_MON_ST() {
    init0();
  }
  ...
  public T72_ENGCSPT_MON_ST with_Stat_Mon(String Stat_Mon) {
    this.Stat_Mon = Stat_Mon;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_HouseHld_pty_ID(String HouseHld_pty_ID) {
    this.HouseHld_pty_ID = HouseHld_pty_ID;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_EngCspt_Cd(String EngCspt_Cd) {
    this.EngCspt_Cd = EngCspt_Cd;
    return this;
  }
  private String HouseHld_pty_Nm;
  public String get_HouseHld_pty_Nm() {
    return HouseHld_pty_Nm;
  }
  public void set_HouseHld_pty_Nm(String HouseHld_pty_Nm) {
    this.HouseHld_pty_Nm = HouseHld_pty_Nm;
  }
  public T72_ENGCSPT_MON_ST with_HouseHld_pty_Nm(String HouseHld_pty_Nm) {
    this.HouseHld_pty_Nm = HouseHld_pty_Nm;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_HouseHld_Lvl(Integer HouseHld_Lvl) {
    this.HouseHld_Lvl = HouseHld_Lvl;
    return this;
  }
  private String EngCspt_Nm;
  public String get_EngCspt_Nm() {
    return EngCspt_Nm;
  }
  public void set_EngCspt_Nm(String EngCspt_Nm) {
    this.EngCspt_Nm = EngCspt_Nm;
  }
  public T72_ENGCSPT_MON_ST with_EngCspt_Nm(String EngCspt_Nm) {
    this.EngCspt_Nm = EngCspt_Nm;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_Measr_Unit(String Measr_Unit) {
    this.Measr_Unit = Measr_Unit;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_Sum_Val(java.math.BigDecimal Sum_Val) {
    this.Sum_Val = Sum_Val;
    return this;
  }
  ...
  public T72_ENGCSPT_MON_ST with_Data_Dt(java.sql.Date Data_Dt) {
    this.Data_Dt = Data_Dt;
    return this;
  }
  private Integer REC_SEQ;
  public Integer get_REC_SEQ() {
    return REC_SEQ;
  }
  public void set_REC_SEQ(Integer REC_SEQ) {
    this.REC_SEQ = REC_SEQ;
  }
  public T72_ENGCSPT_MON_ST with_REC_SEQ(Integer REC_SEQ) {
    this.REC_SEQ = REC_SEQ;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof T72_ENGCSPT_MON_ST)) {
      return false;
    }
    T72_ENGCSPT_MON_ST that = (T72_ENGCSPT_MON_ST) o;
    boolean equal = true;
    ...
    equal = equal && (this.HouseHld_pty_Nm == null ? that.HouseHld_pty_Nm == null : this.HouseHld_pty_Nm.equals(that.HouseHld_pty_Nm));
    equal = equal && (this.HouseHld_Lvl == null ? that.HouseHld_Lvl == null : this.HouseHld_Lvl.equals(that.HouseHld_Lvl));
    equal = equal && (this.EngCspt_Nm == null ? that.EngCspt_Nm == null : this.EngCspt_Nm.equals(that.EngCspt_Nm));
    ...
    equal = equal && (this.REC_SEQ == null ? that.REC_SEQ == null : this.REC_SEQ.equals(that.REC_SEQ));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.HouseHld_pty_ID = JdbcWritableBridge.readString(2, __dbResults);
    this.EngCspt_Cd = JdbcWritableBridge.readString(3, __dbResults);
    this.HouseHld_pty_Nm = JdbcWritableBridge.readString(4, __dbResults);
    this.HouseHld_Lvl = JdbcWritableBridge.readInteger(5, __dbResults);
    this.EngCspt_Nm = JdbcWritableBridge.readString(6, __dbResults);
    this.Measr_Unit = JdbcWritableBridge.readString(7, __dbResults);
    this.Sum_Val = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.Data_Dt = JdbcWritableBridge.readDate(9, __dbResults);
    this.REC_SEQ = JdbcWritableBridge.readInteger(10, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(HouseHld_pty_ID, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(EngCspt_Cd, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(HouseHld_pty_Nm, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(HouseHld_Lvl, 5 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(EngCspt_Nm, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(Measr_Unit, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(Sum_Val, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeDate(Data_Dt, 9 + __off, 91, __dbStmt);
    JdbcWritableBridge.writeInteger(REC_SEQ, 10 + __off, 4, __dbStmt);
    return 10;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.HouseHld_pty_Nm = null;
    } else {
    this.HouseHld_pty_Nm = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.EngCspt_Nm = null;
    } else {
    this.EngCspt_Nm = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    this.REC_SEQ = Integer.valueOf(__dataIn.readInt());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.HouseHld_pty_Nm) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, HouseHld_pty_Nm);
    }
    ...
    if (null == this.EngCspt_Nm) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, EngCspt_Nm);
    }
    ...
    if (null == this.REC_SEQ) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.REC_SEQ);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(HouseHld_pty_Nm==null?"\\N":HouseHld_pty_Nm, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(HouseHld_Lvl==null?"\\N":"" + HouseHld_Lvl, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(EngCspt_Nm==null?"\\N":EngCspt_Nm, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(REC_SEQ==null?"\\N":"" + REC_SEQ, delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.HouseHld_pty_Nm = null; } else {
      this.HouseHld_pty_Nm = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.EngCspt_Nm = null; } else {
      this.EngCspt_Nm = __cur_str;
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.REC_SEQ = null; } else {
      this.REC_SEQ = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    T72_ENGCSPT_MON_ST o = (T72_ENGCSPT_MON_ST) super.clone();
    o.Data_Dt = (o.Data_Dt != null) ? (java.sql.Date) o.Data_Dt.clone() : null;
    return o;
  }

  public void clone0(T72_ENGCSPT_MON_ST o) throws CloneNotSupportedException {
    o.Data_Dt = (o.Data_Dt != null) ? (java.sql.Date) o.Data_Dt.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("HouseHld_pty_Nm", this.HouseHld_pty_Nm);
    __sqoop$field_map.put("HouseHld_Lvl", this.HouseHld_Lvl);
    __sqoop$field_map.put("EngCspt_Nm", this.EngCspt_Nm);
    ...
    __sqoop$field_map.put("REC_SEQ", this.REC_SEQ);
