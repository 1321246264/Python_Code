...
def formatTable(file):
    ...
    for i in range(len(tables)):
        ...
        maptable['SQOOP_SPLITKEY'] = tables[i][splitKey]
        maptable['SQOOP_DATARANGE'] = tables[i][dataRange]
        # 存储成map方便使用
