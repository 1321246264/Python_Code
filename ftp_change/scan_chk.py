...
if __name__ == '__main__':
    ...
    # 参数个数为一个时
        ...
        # for root, dirs, files in os.walk('/home/operator/datatom/FtpToHive/data/20200909/'):
        #
        #     # root 表示当前正在访问的文件夹路径
        #     # dirs 表示该文件夹下的子目录名list
        #     # files 表示该文件夹下的文件list
        ...
        #     # 遍历文件
        #     for txtfile in files:
        #         if txtfile.split(".")[-1] == 'xml':
        #             ftpinstance.upload_file(ftp, '/home/operator/datatom/FtpToHive/data/20200909/' + txtfile, ftp_dir + txtfile)
