        ...
        try:
            ...
            for xml_file in fileLists:
                if re.search(r".xml", xml_file):
                    ...
                    csv_file = re.sub("xml", "csv", xml_file)

                    ftpinstance.download_file(ftp, ftp_xmlfile_path, dst_xmlfile_path)

                    txt_file = re.sub("xml", "txt", xml_file)

                    chk_file = re.sub("xml", "chk", xml_file)
                    ...
                    # ftp.rename(ftp_dir + xml_file, ftp_dir + 'xml_back/' + xml_file)
